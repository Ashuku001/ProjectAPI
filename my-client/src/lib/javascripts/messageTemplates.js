...
// a list of transactions from the time an order is placed to delivery(message to send to customer)
// message template create a 
    ...
    components: [
      {
        type: "BODY",
        text:
          "Hi, {{1}}! How great to have you here 😃" +
          "\n" +
        ...
        example: {
          body_text: [
            [
              "Bob",
              "OLIVE OIL",
              "https://customer.your-awesome-grocery-store-demo.com/my-account/orders/02-953022600",
            ],
          ],
        },
      },
    ...
    components: [
      {
        type: "BODY",
        text:
          "Hello {{1}}, your order {{2}} is already on its way and will be delivered to you on {{3}} :)" +
          "\n" +
