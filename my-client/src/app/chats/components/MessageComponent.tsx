...
function MessageComponent({ message }: Props) {
    return (
        <div className='my-2 max-w-5xl flex flex-row text-black dark:text-white '>
            <div className={`px-3 py-2 rounded-lg w-[200px] md:w-[350px] lg:w-[500px ] ${message?.from_customer ? 'bg-gray-400 dark:bg-gray-800 mr-auto rounded-tl-none' : 'dark:bg-green-800 bg-green-600  ml-auto rounded-tr-none'} ${message.id < 0 ? 'opacity-50' : ''}`}>
